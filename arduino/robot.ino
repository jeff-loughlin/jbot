...
//      Serial.print(outMsg);
        ...
        int distanceLeft = 42; // Do something useful here
        int distanceCenter = 84;
        int distanceRight = 126;

        // Send it to the controller
        sprintf(outMsg, "DL:%d\r", distanceLeft);
        Serial.print(outMsg);
        sprintf(outMsg, "DC:%d\r", distanceCenter);
        Serial.print(outMsg);
        sprintf(outMsg, "DR:%d\r", distanceRight);
        Serial.print(outMsg);
